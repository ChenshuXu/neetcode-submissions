...
|---|---|---|---|
| Linked Merchant / Entity Clustering | Partial + custom | [721 Accounts Merge](https://leetcode.com/problems/accounts-merge/); [2092 Find All People With Secret](https://leetcode.com/problems/find-all-people-with-secret/) | [`stripe_linked_merchant_clustering`](../stripe_linked_merchant_clustering/) |
| Join Two Datasets | Partial + custom | [175 Combine Two Tables](https://leetcode.com/problems/combine-two-tables/) | [`stripe_join_two_datasets`](../stripe_join_two_datasets/) |
| Merchant Fraud Score | Partial + custom | [1396 Design Underground System](https://leetcode.com/problems/design-underground-system/) | [`stripe_merchant_fraud_score`](../stripe_merchant_fraud_score/) |
| WebSocket Load Balancer | Partial + custom | [1606 Find Servers That Handled Most Number of Requests](https://leetcode.com/problems/find-servers-that-handled-most-number-of-requests/); [1882 Process Tasks Using Servers](https://leetcode.com/problems/process-tasks-using-servers/) | [`stripe_websocket_load_balancer`](../stripe_websocket_load_balancer/) |
| Datacenter Request Routing | Partial + custom | [973 K Closest Points to Origin](https://leetcode.com/problems/k-closest-points-to-origin/) | [`stripe_datacenter_request_routing`](../stripe_datacenter_request_routing/) |
| Catch Me If You Can / Merchant Fraud Thresholds | Partial + custom | [2043 Simple Bank System](https://leetcode.com/problems/simple-bank-system/) | [`stripe_merchant_fraud_thresholds`](../stripe_merchant_fraud_thresholds/) |
| Credit Card Validation / Luhn | Custom | No meaningful equivalent | [`stripe_credit_card_validation`](../stripe_credit_card_validation/) |
...
| Registry with REGISTER / SET_HEALTHY | Alias | Reuse [`stripe_datacenter_request_routing`](../stripe_datacenter_request_routing/) |
| Card Range Obfuscation | Alias | Reuse [`stripe_credit_card_validation`](../stripe_credit_card_validation/) redaction part |
| Stripe Payment Card Validation System | Alias | Reuse [`stripe_credit_card_validation`](../stripe_credit_card_validation/) |
...
| Accept-Language Header Parser | Custom | [`stripe_accept_language_parser`](../stripe_accept_language_parser/) |
...
| Authorization Request / Fraud Reporting | Alias | Reuse [`stripe_merchant_fraud_thresholds`](../stripe_merchant_fraud_thresholds/) |
...
| Payment Reconciliation | Partial + custom | [350 Intersection of Two Arrays II](https://leetcode.com/problems/intersection-of-two-arrays-ii/); [`stripe_payment_reconciliation`](../stripe_payment_reconciliation/) |
...
```bash
python3 custom_practice/<pack_name>/run_tests.py
```
