...
```bash
python3 custom_practice/snowflake/bounded_event_frequency_tracker/run_tests.py --list
python3 custom_practice/snowflake/bounded_event_frequency_tracker/run_tests.py --case boundary
```
