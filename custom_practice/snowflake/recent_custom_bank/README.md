...
```bash
python3 custom_practice/snowflake/recent_custom_bank/run_tests.py --list-problems
python3 custom_practice/snowflake/recent_custom_bank/run_tests.py horizontal_pod_autoscaler
python3 custom_practice/snowflake/recent_custom_bank/run_tests.py sql_table_extraction --list
python3 custom_practice/snowflake/recent_custom_bank/run_tests.py sessionization --case gap
```
