...
```bash
python3 custom_practice/stripe/linked_merchant_clustering/run_tests.py --list
python3 custom_practice/stripe/linked_merchant_clustering/run_tests.py --case split
```
